          ...
          <table class="table is-bordered contract-receipt-list is-hidden-touch">
            ...
            <tr v-for="receipt in contractReceiptList" v-if="receipt.status !== -1">
              ...
              <td class="receipt-button-wrapper">
                <button class="button is-danger is-medium" v-if="(userPermit === 'C' && receipt.status !== 3) || (userPermit === 'B' && receipt.status !== 2 && receipt.status !== 3)" @click="changeReceiptStatus(receipt, 0)">반려</button>
                ...
                <button class="button is-primary is-medium" v-if="(userPermit === 'C' && receipt.status !== 3)" @click="changeReceiptStatus(receipt, 3)">입금완료</button>
              </td>
            </tr>
